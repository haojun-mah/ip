...
public class EventTest {
   ...
   @Test @DisplayName("Ensure dateline string format is within expectation")
   ...
   @Test @DisplayName("Ensure that error is thrown if no missing either date for from and to")
   public void event_noDate_throwMissingEventException() {
      assertThrows(MissingEventException.class, () -> new Event("123 /from123 /to"));
   }

   @Test @DisplayName("Ensure that error is thrown if wrong dateformat is parsed")
